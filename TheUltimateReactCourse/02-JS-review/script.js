...
// Takes the first and second elements of the array and assigns them to the variables
...
const summary = `${title}, a ${pages}-long book, was written by ${author} and published in ${getYear}. The book has ${
  hasMovieAdaptation ? "" : "not"
} been adapted as a movie`;
summary;

pagesRange = pages > 1000 ? "over a thousand" : "less than a thousand";
pagesRange;
...
const a = [3, 7, 1, 9, 6];
const aSortedAsc = a.sort((b, c) => b - c);
aSortedAsc;
a;
const aSortedDesc = a.sort((b, c) => c - b);
aSortedDesc;
a;

aCopySortedAsc = a.slice().sort((b, c) => b - c);
aCopySortedAsc;
a;
